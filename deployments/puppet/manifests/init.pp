...
class splunk_otel_collector (
  String $splunk_access_token,
  String $splunk_realm,
  Variant[String, Integer] $splunk_memory_total_mib,
  String $splunk_ballast_size_mib,
  String $fluentd_capng_c_version,
  String $fluentd_systemd_version,
  Boolean $manage_repo,
  Boolean $with_auto_instrumentation,
  String $package_stage,
  Stdlib::HTTPUrl $apt_repo_url,
  String $apt_repo,
  String $service_user,
  String $service_group,
  String $apt_gpg_key,
  String $yum_gpg_key,
  Boolean $with_fluentd,
  Stdlib::HTTPUrl $fluentd_repo_base,
  String $fluentd_gpg_key,
  String $auto_instrumentation_ld_so_preload,
  String $auto_instrumentation_resource_attributes,
  String $auto_instrumentation_service_name,
  String $collector_version,
  Stdlib::Absolutepath $splunk_bundle_dir,
  Stdlib::Absolutepath $splunk_collectd_dir,
  Stdlib::Absolutepath $collector_config_source,
  Stdlib::Absolutepath $collector_config_dest,
  String $fluentd_version,
  Stdlib::Absolutepath $fluentd_config_source,
  Stdlib::Absolutepath $fluentd_config_dest,
  String $auto_instrumentation_version,
  String $auto_instrumentation_java_agent_jar,
  Stdlib::HTTPUrl $splunk_ingest_url = "https://ingest.${splunk_realm}.signalfx.com",
  Stdlib::HTTPUrl $splunk_api_url    = "https://api.${splunk_realm}.signalfx.com",
  Stdlib::HTTPUrl $splunk_trace_url  = "${splunk_ingest_url}/v2/trace",
  Stdlib::HTTPUrl $splunk_hec_url    = "${splunk_ingest_url}/v1/log",
  String $splunk_hec_token           = $splunk_access_token,
  Stdlib::HTTPUrl $yum_repo_url      = "https://splunk.jfrog.io/splunk/otel-collector-rpm/${package_stage}/\$basearch",
  Stdlib::HTTPUrl $win_repo_url      = "https://dl.signalfx.com/splunk-otel-collector/msi/${package_stage}",
) {
